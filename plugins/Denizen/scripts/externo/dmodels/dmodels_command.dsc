...
dmodels_command:
    ...
    data:
        load_example: <&[error]>'path' should be a valid file name, for example if you have <&[emphasis]>../../cfinfo/dmodels/example.bbmodel<&[error]>, you should do: <&[warning]>/dmodels load example
    script:
    ...
    - choose <[arg1]>:
        - case load:
            ...
            - if !<[path].to_lowercase.matches_character_set[<script[dmodels_cmd_data].data_key[valid_chars]>]>:
                ...
                - narrate <script.parsed_key[load_example]>
                - stop
            - if !<util.has_file[../../cfinfo/dmodels/<[path]>.bbmodel]>:
        ...
        - case loadall:
            - ~run dmodels_gather_folder def.folder:../../cfinfo/dmodels save:list
...
dmodels_tab_2:
    ...
    - if <[args].first> == load:
        ...
        - else:
            - define path <empty>
        - determine <util.list_files[../../cfinfo/dmodels/<[path]>].parse[before_last[.bbmodel]]||<list>>
...
dmodels_gather_folder:
    ...
    - foreach <util.list_files[<[folder]>]||<list>> as:file:
        ...
        - if <[file].ends_with[.bbmodel]>:
            - define clean_name <[full_file].after[../../cfinfo/dmodels/].before_last[.bbmodel]>
